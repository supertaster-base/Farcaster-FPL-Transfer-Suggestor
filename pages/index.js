...
`;
  ...
  return (
    <>
      ...
      <div className="
        min-h-screen
        bg-gradient-to-b from-gray-950 to-[#0d1220]
        text-gray-100
        w-full
        mx-auto
        flex flex-col
      ...
      ">
        ...
        {/* HEADER */}
        <header className="text-center max-w-[280px] mx-auto">
        ...
        <div className="
          ...
          p-4 space-y-3 shadow-sm text-center
        ">
          ...
          <button
            ...
            disabled={loading}
            className="
              relative mx-auto max-w-[260px] w-full
              text-sm font-semibold py-2 rounded-md
              ...
              <>
                ...
                <button
                  ...
                  className="
                    ...
                    text-white font-semibold py-2 rounded-md text-sm
                  "
                >
                  Share Transfer
                </button>
        ...
        <footer className="text-center text-gray-500 text-[11px] pb-6">
