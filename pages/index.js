    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="https://farcaster-fpl-transfer-suggestor.vercel.app/api/frame-image?managerId=619981"
        />
      ...
      <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col md:flex-row relative overflow-hidden">
        ...
        <div className="flex items-center justify-between md:hidden p-4 border-b border-gray-800 bg-gray-900/90 backdrop-blur-md">
          <h1 className="text-lg font-semibold text-indigo-400">FPL Dashboard</h1>
          <button
        ...
        >
          <h2 className="text-xl font-semibold mb-4 text-indigo-400">Recent Suggestions</h2>
          <div className="space-y-3 overflow-y-auto max-h-[70vh]">
            {recent.length === 0 && <p className="text-gray-500 text-sm">No suggestions yet</p>}
            {recent.map((s, i) => (
              <div
                key={i}
              ...
              >
                ...
                <p className="text-sm">
                  <strong className="text-fuchsia-300">In:</strong> {s.in ? s.in : "—"}
                </p>
        ...
        >
          <div className="w-full max-w-2xl bg-gray-900/90 rounded-2xl shadow-2xl p-6 md:p-8 border border-gray-800 mt-4 md:mt-0 backdrop-blur-md">
            ...
            <p className="text-gray-400 mb-6 text-center md:text-left text-sm md:text-base">
              Enter your public FPL Manager ID to view your team and get a same-position transfer
              suggestion.
            </p>
            ...
            {suggestion && (
              <div className="mt-6 p-4 bg-gray-800 border border-gray-700 rounded-xl">
                <h2 className="text-lg font-semibold text-indigo-300 mb-3">Suggested Transfer</h2>
                  ...
                  {suggestion.in ? (
                    <>
                      <div>
                        ...
                        {suggestion.in_cost && `(${suggestion.in_cost}m)`} — form {suggestion.form}
                      </div>
                      <div className="text-gray-400 text-sm">Position: {suggestion.position}</div>
                    </>
                  ) : (
