...
export default async function handler() {
  const manifest = {
    ...
    accountAssociation: {
      header:
        "eyJmaWQiOjI5NzA2NiwidHlwZSI6ImN1c3RvZHkiLCJrZXkiOiIweGRiODYxMzE3RDZlM2ZmMjNBN0U3RmNlMGJiOWNENWQ1NjE1QzBkOUQifQ",
      payload:
        "eyJkb21haW4iOiJmYXJjYXN0ZXItZnBsLXRyYW5zZmVyLXN1Z2dlc3Rvci52ZXJjZWwuYXBwIn0",
      signature:
        "zBuFR2Xwmj9JPir5InmixwS3Lt7PdN7yz6e3eUfQ+RMq6KSqTRJDjZdv9rI6RcFdeE2ZIKKuzb+7xpJYIh9mghw=",
    },
  };
